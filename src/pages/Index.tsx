          ...
          <Dialog>
            ...
            <DialogContent className="bg-background border-border">
              ...
              <div className="space-y-3 text-sm">
                <p>gomo6 - это современный имиджборд, вдохновлённая классическими форумами.</p>
                <p>Здесь вы можете:</p>
                <ul className="list-disc list-inside space-y-1 ml-2">
                  <li>Создавать треды и общаться с другими пользователями без опаски</li>
                  <li>Загружать изображения к постам</li>
                  <li>Зарабатывать достижения за активность</li>
                  <li>Узнавать много нового</li>
                  <li>хз?</li>
                </ul>
                <p className="mt-4">
