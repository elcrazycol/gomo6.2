# Инструкции по настройке системы сообщений и правил в Supabase
...
## Настройка доски правил

### 8. Создание доски правил

Примените миграцию для создания доски правил:
```
supabase/migrations/20260110010000_add_rules_board.sql
```
...
Это создаст доску `/rules` где администраторы смогут размещать правила форума.
