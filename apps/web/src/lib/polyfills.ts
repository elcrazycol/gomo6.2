...
//
// Some bundled dependencies (e.g. react-virtuoso, which powers the messenger
// message list) call `Object.hasOwn()`. That API landed in ES2022 and is
// missing on older mobile browsers / WebViews (iOS Safari < 15.4, older
// Android). Without a polyfill the messenger crashes on open with
