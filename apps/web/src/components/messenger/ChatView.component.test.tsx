...
const defaultProps = {
  onBack: vi.fn(),
  composerRef: { current: null } as React.RefObject<{ focus: () => void; moveCaretToEnd: () => void; insertText: (text: string) => void; insertEmoji: (data: unknown, opts?: { focus?: boolean }) => void; getEditor: () => null } | null>,
