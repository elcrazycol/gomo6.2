...
export const MessengerView = () => {
  ...
  // The messenger is a CSS-box surface: main.is-messenger-page is sized
  // height: var(--app-vh) and only the internal message list scrolls — the
  // document itself never scrolls on /messages, so iOS has nothing to pan
  // when the composer input is focused (no document pin needed).
