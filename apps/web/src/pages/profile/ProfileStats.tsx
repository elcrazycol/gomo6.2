...
function Stat({
  ...
  return (
    <button
      ...
      onClick={onClick}
      title={title}
      className="inline-flex items-baseline gap-1 whitespace-nowrap rounded px-1 py-0.5 transition-[text-shadow] duration-150 hover:[text-shadow:0_1px_10px_rgb(0_0_0_/_0.45)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
    >
