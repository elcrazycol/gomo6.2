...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/admin/gifts/{id}/layers": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Layer data: layer_type (gift|background|symbol), image_url, optional name/sort_order",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.ClientErrorRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/custom_emojis/resolve": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Emoji IDs to resolve (max 200)",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/gifts/{giftRecordID}/upgrade": {
            "post": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "User gift record ID",
                        "name": "giftRecordID",
                        "in": "path",
                        "required": true
                    }
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/integrations.AuthURLResponse"
                        }
                    }
                }
            }
        },
        "/integrations/spotify/callback": {
            "get": {
                "tags": [
                    "Integrations"
                ],
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/integrations.NowPlayingResponse"
                        }
                    }
                }
            }
        },
        "/integrations/spotify/now-playing/{user_id}": {
            "get": {
                "tags": [
                    "Integrations"
                ],
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/integrations.IntegrationStatusResponse"
                        }
                    }
                }
            }
        ...
        "/messenger/conversations/{id}/messages": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Decimal BIGINT cursor; return messages after this monotonic event cursor",
                        "name": "since_event_id",
                        "in": "query"
                    }
                ],
        ...
        "/messenger/conversations/{id}/messages/{msgId}/notes-meta": {
            "put": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.UpdateNotesMetaRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/messenger/groups": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Group name and initial member IDs",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.AddMembersRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/messenger/groups/{id}/members/{userId}": {
            "delete": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/oauth/authorize": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "CSRF state, echoed back",
                        "name": "state",
                        "in": "query"
                    },
                    {
                    ...
                    {
                        "type": "string",
                        "description": "Must be 'true' when called from the consent page",
                        "name": "consent",
                        "in": "query"
                    }
                ],
        ...
        "/oauth/introspect": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Client ID (client authentication)",
                        "name": "client_id",
                        "in": "formData"
                    },
                    {
        ...
        "/oauth/token": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Must match the authorize request",
                        "name": "redirect_uri",
                        "in": "formData"
                    },
                    {
        ...
        "/rpc/delete_avatar_from_history": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/storage/v1/upload": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Bucket: uploads, content, post-images, avatars, wall, emojis",
                        "name": "bucket",
                        "in": "formData",
                        "required": true
                    },
                    {
                        "type": "string",
                        "description": "Object key — must start with \u003cuserID\u003e/ (or \u003cuserID\u003e/messenger/ for uploads)",
                        "name": "key",
                        "in": "formData",
                        "required": true
                    }
    ...
    "definitions": {
        ...
        "handlers.CreateGroupRequest": {
            ...
            "properties": {
                "member_ids": {
                    "description": "creator + 99 = maxGroupSize",
                    "type": "array",
                    "maxItems": 99,
                    "items": {
                        "type": "string"
        ...
        "handlers.SendMessageRequest": {
            ...
            "properties": {
                "attachments": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/handlers.AttachmentInput"
                    }
                },
                "client_id": {
                    "type": "string"
        ...
        "handlers.UpdateNotesMetaRequest": {
            "type": "object",
            "required": [
                "meta"
            ],
        ...
        "integrations.NowPlayingResponse": {
            "type": "object",
            "properties": {
                "album_art_url": {
                    "type": "string"
                ...
                "updated_at": {
                    "description": "Unix ms when state was captured",
                    "type": "integer"
                }
            }
        },
