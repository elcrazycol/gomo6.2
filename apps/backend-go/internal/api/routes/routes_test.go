...
var expectedRoutes = []string{
	...
	"POST /api/v1/gomosub_memberships",
	"POST /api/v1/gomosub_memberships/*path",
	"PUT /api/v1/gomosub_memberships",
	"PUT /api/v1/gomosub_memberships/*path",
	"DELETE /api/v1/gomosub_memberships",
	"DELETE /api/v1/gomosub_memberships/*path",
	"GET /api/v1/channels",
	"GET /api/v1/channels/*path",
	"POST /api/v1/channels",
	"POST /api/v1/channels/*path",
	"PUT /api/v1/channels",
	"PUT /api/v1/channels/*path",
	"DELETE /api/v1/channels",
	"DELETE /api/v1/channels/*path",
	"GET /api/v1/gomosub_roles",
	"GET /api/v1/gomosub_roles/*path",
	"POST /api/v1/gomosub_roles",
	"POST /api/v1/gomosub_roles/*path",
	"PUT /api/v1/gomosub_roles",
	"PUT /api/v1/gomosub_roles/*path",
	"DELETE /api/v1/gomosub_roles",
	"DELETE /api/v1/gomosub_roles/*path",
	"GET /api/v1/channel_permissions",
	"GET /api/v1/channel_permissions/*path",
	"POST /api/v1/channel_permissions",
	"POST /api/v1/channel_permissions/*path",
	"PUT /api/v1/channel_permissions",
	"PUT /api/v1/channel_permissions/*path",
	"DELETE /api/v1/channel_permissions",
	"DELETE /api/v1/channel_permissions/*path",
	...
	"GET /api/v1/user_awards/*path",
	"POST /api/v1/admin/awards",
	"PATCH /api/v1/admin/awards",
	"DELETE /api/v1/admin/awards",
	"POST /api/v1/admin/awards/image",
	"POST /api/v1/admin/awards/grant",
	"POST /api/v1/admin/awards/revoke",
	"GET /api/v1/admin/awards/grants",
	...
	"GET /api/v1/profile_album_posts",
	"GET /api/v1/profile_album_posts/*path",
	"POST /api/v1/profile_album_posts",
	"POST /api/v1/profile_album_posts/*path",
	"DELETE /api/v1/profile_album_posts",
	"DELETE /api/v1/profile_album_posts/*path",
	"GET /api/v1/profile_albums",
	"GET /api/v1/profile_albums/*path",
	"POST /api/v1/profile_albums",
	"POST /api/v1/profile_albums/*path",
	"PUT /api/v1/profile_albums",
	"PUT /api/v1/profile_albums/*path",
	"DELETE /api/v1/profile_albums",
	"DELETE /api/v1/profile_albums/*path",
