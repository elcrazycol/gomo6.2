...
export function CodeTooltip({ content, children }: CodeTooltipProps) {
  ...
  return (
    <span className="relative inline-block">
      <span
        ...
        className="cursor-help hover:bg-gray-100 dark:hover:bg-gray-800 px-1 rounded transition-colors"
      >
        {children}
      </span>
      {isVisible && (
